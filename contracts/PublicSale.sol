...
contract PublicSale is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    uint256 constant startDate = 1696032000; // 00 horas del 30 de septiembre del 2023 GMT
    ...
    function initialize(
        ...
        // Asignar roles a los administradores del contrato
    ...
    function purchaseWithTokens(uint256 _id) public {
        require(_id >= 0 && _id <= 699, "La compra no se encuentra disponible");
        require(!mintedToken[_id], "Id Invalida");
    ...
    function getPriceForId(uint _id) public view returns (uint) {
        ...
        if(_id >= 0 && _id <= 199) {
            ...
            uint priceCalculated = (10000 + 2_000 * ((block.timestamp - startDate) / 1 days)) * 10 ** 18;
    ...
    function purchaseWithEtherAndId(uint256 _id) public payable {
        ...
        require(_id >= 700 && _id <= 999, "La compra no se encuentra disponible");
        require(!mintedToken[_id], "Id Invalida");
